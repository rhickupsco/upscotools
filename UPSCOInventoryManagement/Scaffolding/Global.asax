...
<script RunAt="server">
    public static void RegisterRoutes(RouteCollection routes) {
        ...
        // Uncomment this line to register an ADO.NET Entity Data
        ...
        model.RegisterContext(typeof(EquipmentInventoryModel.EquipmentInventoryEntities), new ContextConfiguration()
