<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PhoneNumber_Edit.ascx.cs" Inherits="DynamicData_FieldTemplates_PhoneNumber_EditField" %>

<asp:TextBox ID="TextBox1" runat="server" CssClass="droplist" Text='<%# FieldValueEditString %>'></asp:TextBox>
