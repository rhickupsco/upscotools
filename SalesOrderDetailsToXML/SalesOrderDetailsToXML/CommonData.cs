...
namespace Data_Access
{
    public static class CommonData
    {
        ...
        internal static DataTable GetAllOpenSalesOrders()
        {
            ODBCDataAccess bs = new ODBCDataAccess();

            DataTable tblBuildData = new DataTable();

           string sql = GetAllOpenOrdersQuery();
        ...
        private static string GetAllOpenOrdersQuery()
        {
            string sql = string.Empty;

            sql = "SELECT Distinct soh.SalesOrderNo, soh.OrderType FROM " +
            "SO_SalesOrderHeader soh " +
            "WHERE (soh.OrderStatus in ('O','H','N')) AND " +
            "(soh.OrderType in ('B','S')) " +
            "ORDER BY soh.SalesOrderNo DESC";

            return sql;
        }

        internal static DataTable GetAllSalesOrderItems()
        {
            ODBCDataAccess bs = new ODBCDataAccess();

            DataTable tblBuildData = new DataTable();

            string sql = GetAllSalesOrderItemsQuery();
        ...
        private static string GetAllSalesOrderItemsQuery()
        {
            string sql = string.Empty;
            sql = "SELECT SO_SalesOrderHeader.SalesOrderNo+SO_SalesOrderDetail.ItemCode+SO_SalesOrderDetail.LineSeqNo AS 'unique', " +
                  "SO_SalesOrderHeader.SalesOrderNo, SO_SalesOrderDetail.itemCode, SO_SalesOrderDetail.PromiseDate, SO_SalesOrderHeader.OrderType, " +
                  "SO_SalesOrderDetail.UDF_ORIG_PROMISE FROM SO_SalesOrderDetail SO_SalesOrderDetail, SO_SalesOrderHeader SO_SalesOrderHeader " +
                  "WHERE SO_SalesOrderDetail.SalesOrderNo = SO_SalesOrderHeader.SalesOrderNo " +
                  "AND (OrderType  in ('B','S')) AND " +
                  "(SO_SalesOrderHeader.OrderStatus in ('O','H','N')) Order by SO_SalesOrderHeader.SalesOrderNo DESC";
            return sql;
        }
        ...
        private static string GetMySalesOrdersQuery()
        {
            ...
            "AND(SO_SalesOrderHeader.OrderStatus = 'O') AND (SO_SalesOrderHeader.OrderType = 'S')) ORDER BY SO_SalesOrderHeader.SalesOrderNo DESC";
        ...
        private static string GetSalesOrderItemsQuery()
        {
            string sql = string.Empty;
            sql = "SELECT SO_SalesOrderHeader.SalesOrderNo+SO_SalesOrderDetail.ItemCode+SO_SalesOrderDetail.LineSeqNo AS 'unique', " +
                  "SO_SalesOrderHeader.SalesOrderNo, SO_SalesOrderDetail.ItemCode, AR_Customer.CustomerName " +
                  ...
                  "AND (OrderType = 'S') AND (SO_SalesOrderHeader.SalespersonNo = ? ) AND " +
